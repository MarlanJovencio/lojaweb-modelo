    ...
    <div class="col-lg-10 col-xl-9 mx-auto">
        <div class="card flex-row my-5 border-0 shadow rounded-3 overflow-hidden">
            ...
            <div class="card-body p-4 p-sm-5">
                ...
                <form action="./../controllers/cliente-controller.inc.php" method="post">
                    ...
                    <div class="d-grid mb-2">
                        <button class="btn btn-lg btn-primary btn-login fw-bold text-uppercase" type="submit">Efetuar
                            Login</button>
                    </div>
                    ...
                    <a class="d-block text-center mt-2 small" href="formCliente.php">Não possui uma conta? Cadastre-se
                        aqui</a>
