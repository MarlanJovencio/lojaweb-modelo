  ...
  <ul class="nav col-12 col-md-auto mb-2 justify-content-center mb-md-0">
    ...
    <li class="nav-item dropdown">
      ...
      <ul class="dropdown-menu">
        <li><a class="dropdown-item" href="./../controllers/produto-controller.inc.php?pOpcao=3">Cadastrar</a></li>
        <li><a class="dropdown-item" href="#">Cadastrar Vários</a></li>
        <li><a class="dropdown-item" href="./../controllers/produto-controller.inc.php?pOpcao=2">Consultar</a></li>
        <li>
          <hr class="dropdown-divider">
        </li>
        <li><a class="dropdown-item" href="./../controllers/produto-controller.inc.php?pOpcao=7">Show Room</a></li>
      </ul>
    </li>
    ...
    <li class="nav-item dropdown">
      ...
      <ul class="dropdown-menu">
        <li><a class="dropdown-item" href="./../controllers/fabricante-controller.inc.php?pOpcao=2">Cadastrar</a></li>
        <li><a class="dropdown-item" href="./../controllers/fabricante-controller.inc.php?pOpcao=1">Consultar</a></li>
      </ul>
    </li>
